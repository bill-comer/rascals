...
<div id="titlebar" style="width:100%;height:35px;">
   <div class="icon" style="width:100%;height:35px;">
      <table width="100%" height="35px;">
         <tr>
            <td width="1%"><img style="cursor: default;" src="pages/images/AFMS_button.jpg" width="25" height="25"/></td>
            ...
            <c:choose>
              ...
              <c:otherwise>
                <td width="2%" align="right"><img alt="www.utilisoft.co.uk" src="pages/images/utilisoft_logo_icon.png" style="cursor:pointer;"
