...
<c:forEach
  items="${usersCommand.identifier}" varStatus="loopStatus">
  <spring:bind path="usersCommand.identifier[${loopStatus.index}]">
...
<c:if test="${usersCommand.canCreateNew}">
</c:if>
  ...
  <table align="center">
    <tr>
       <td>
         <a class="button_input" onclick="this.blur(); window.location.href='listUsers.htm?create';" onmouseover="buttonHover(this);" onmouseout="buttonNormal(this);" style="text-align: center">
                <span><spring:message code="button.admin.users.create.new"/></span>
         </a>
       </td>
    </tr>
