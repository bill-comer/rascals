...
function calculatePaging(totalRecords, recordsDisplaying, currentPage)
{
  ...
  {
    htmlOut = ' <img onclick="moveToPage(' + (currentPage - 1) + ')" src="pages/images/previous-page.png"/> ';
  }
  ...
  {
    htmlOut = htmlOut + ' <img onclick="moveToPage(' + (currentPage + 1) + ')" src="pages/images/next-page.png"/> ';
  }
