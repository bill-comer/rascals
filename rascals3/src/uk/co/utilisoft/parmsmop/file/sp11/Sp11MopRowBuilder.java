...
@Service("parmsmop.sp11RowBuilder")
public class Sp11MopRowBuilder extends MopRowBuilder
{
  ...
  {
    Sp11PoolHeader header = new Sp11PoolHeader();
...
class Sp11PoolHeader extends MopPoolHeader
{
  @Override
  public String getFileType()
  {
    String reportNumber = new Sp11MopRowBuilder().getReportNumber();
