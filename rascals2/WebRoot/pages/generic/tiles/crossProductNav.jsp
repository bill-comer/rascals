...
<link href="pages/generic/style/cross_product.css"
  ...
  <div class="product_logos">
   ...
   <c:forEach var="detail" items="${products_details}" varStatus="status">
      <c:if test="${status.index > 0}">
        ${close_comment}<img src="pages/generic/images/cross_product/icons_join.gif"
        ></c:if
        ><a href="${detail.url}"
    ...
    <img alt="www.utilisoft.co.uk" title="www.utilisoft.co.uk" src="pages/generic/images/utilisoft_logo_icon.png" style="cursor:pointer;"
