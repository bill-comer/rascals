<%@ taglib uri="/WEB-INF/taglibs/spring.tld" prefix="spring"%>
<%@ taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
<%@ taglib tagdir="/WEB-INF/tags" prefix="tag"%>

<div id="standAloneSearch">
  <div id="loginBox">
    <form name="loginform" id="loginform" method="post" action="j_acegi_security_check" >
      ...
      <div class="box2Body">
        <div id="fragment-1">
          ...
          <p>
            <a href="https://localhost:8443/casldap/logout">
            Fully Log off Single Sign On?
            </a>
          </p>
        </div>
      </div>
