...
<form id="dpiGeneration" name="dpiGeneration" method="post" action="" onsubmit="return false;">
  ...
  <spring:bind path="dpiGenerationCommand.dpiGenerationRequestedAction">
  ...
  <div style="margin-top:10px;margin-left:10px;margin-right:10px;" align="center" >
    ...
    <tag:errors name="dpiGenerationCommand" />
    ...
    <table id="myTable" align="center" style="width: 600px;padding-top: 0px;margin-top:0px;font-family:arial;text-align: center;border: 0px solid black;border-collapse: collapse;font-size: 8pt;vertical-align: top;width:100%; height: 250px;;background-color:white;">
      <tbody>
        <tr>
          <td>
            <spring:message code="field.end.reporting.period" />:
          </td>
          <td>
            <spring:bind path="dpiGenerationCommand.reportingPeriod">
          ...
          <td>
            <a class="button_input" onclick="this.blur();submitGenerateDpiFileForm('Generating DPI File ')" onmouseover="buttonHover(this);" onmouseout="buttonNormal(this);">
