...
function getCurrentDate()
{
  ...
  fixedCurrentTimeMillis = fixedCurrentTimeMillisEl != undefined ? new Number(fixedCurrentTimeMillisEl.value) : new Number(0);
...
function getDateString(currentDate)
{
  ...
  var year = makeTwoDigit(currentDate.getFullYear()); // fix 31/01/112 because firefox, chrome parse Date.getYear()=112 for year 2012
