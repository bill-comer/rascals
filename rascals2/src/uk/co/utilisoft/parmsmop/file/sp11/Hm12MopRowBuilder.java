...
@Service("parmsmop.hm12RowBuilder")
public class Hm12MopRowBuilder extends MopRowBuilder
{
  ...
  {
    Hm12PoolHeader header = new Hm12PoolHeader();
...
class Hm12PoolHeader extends MopPoolHeader
{
  @Override
  public String getFileType()
  {
    String reportNumber = new Hm12MopRowBuilder().getReportNumber();
